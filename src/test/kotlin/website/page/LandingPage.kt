...
class LandingPage(page: Page) : MarketingBasePage(page) {
    ...
    fun isLearnMoreLinkVisible(): Boolean {
        return element("a#cta_how_it_works").isVisible
    }
    ...
    fun isWhatWeTestCtaVisible(): Boolean {
        return element("a#cta_what_we_test").isVisible
    }

    fun clickWhatWeTestCta(): WhatWeTestPage {
        logger.info { "Clicking What We Test CTA" }
        element("a#cta_what_we_test").click()
        return WhatWeTestPage(page)
    }

    // ---------------------- Statistics Section ----------------------

    fun isBiomarkersStatVisible(): Boolean {
        return byText("100+").isVisible
    }

    fun isReportsStatVisible(): Boolean {
        return byText("reports").isVisible
    }
    ...
    fun clickDiagnosticCard(index: Int) {
        logger.info { "Clicking diagnostic card at index: $index" }
        element("a.diagnostic_card").nth(index).click()
    }

    // ---------------------- How It Works Section ----------------------

    fun isHowItWorksSectionVisible(): Boolean {
        return byText("How it works").isVisible
    }

    // ---------------------- Testimonials Section ----------------------

    fun isTestimonialsSectionVisible(): Boolean {
        return byText("What our customers say").isVisible ||
                byText("Testimonials").isVisible
    }

    // ---------------------- Pricing/Membership Section ----------------------

    fun isMembershipSectionVisible(): Boolean {
        return byText("Membership").isVisible ||
                byText("Join Now").isVisible
    }

    // ---------------------- Footer CTA ----------------------

    fun isFooterBookNowVisible(): Boolean {
        // Footer might have a different book now button
        return element("footer a[href*='login']").isVisible
    }
