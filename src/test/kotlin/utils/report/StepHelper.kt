...
object StepHelper {
    ...
    // ── Action Plan Admin ────────────────────────────────────────────────────
    const val AP_ADMIN_LOGIN                   = "Action Plan Admin: Login"
    const val AP_ADMIN_FETCH_TARGET_USER       = "Action Plan Admin: Fetch target user ID"
    const val AP_ADMIN_NAVIGATE                = "Action Plan Admin: Navigate to Health Data and admin dashboard"
    const val AP_ADMIN_OPEN_PDF_TOOL           = "Action Plan Admin: Click 'Go to PDF tool' and wait for page load"
    const val AP_ADMIN_VERIFY_URL              = "Action Plan Admin: Verify final PDF tool URL"
    const val AP_ADMIN_FETCH_USER_DATA         = "Action Plan Admin: Fetch user-data API"
    const val AP_ADMIN_FETCH_RECOMMENDATIONS   = "Action Plan Admin: Fetch user-recommendations API"
    const val AP_ADMIN_VERIFY_USER_INFO        = "Action Plan Admin: Verify User Information section"
    const val AP_ADMIN_VERIFY_HEADER           = "Action Plan Admin: Verify Action Plan header and overview"
    const val AP_ADMIN_VERIFY_SUMMARY          = "Action Plan Admin: Verify Summary and Biomarker Overview"
    const val AP_ADMIN_VERIFY_WHATS_WORKING    = "Action Plan Admin: Verify 'What's Working Well for You' section"
    const val AP_ADMIN_VERIFY_NEEDS_SUPPORT    = "Action Plan Admin: Verify 'What Needs Support' section"
    const val AP_ADMIN_VERIFY_LIFESTYLE        = "Action Plan Admin: Verify Lifestyle Modifications section"
    const val AP_ADMIN_VERIFY_NUTRITION        = "Action Plan Admin: Verify Nutrition Guidance section"
    const val AP_ADMIN_VERIFY_SUPPLEMENTS      = "Action Plan Admin: Verify Supplement Protocol section"
    const val AP_ADMIN_VERIFY_DIAGNOSTICS      = "Action Plan Admin: Verify Diagnostic Testing section"
    const val AP_ADMIN_EXPORT_PDF              = "Action Plan Admin: Export PDF and cross-verify contents"
    const val AP_ADMIN_VALIDATE_HEALTH_OVERVIEW = "Action Plan Admin: Validate health overview text via OpenAI"
    const val AP_ADMIN_VALIDATE_WHY_MATTERS    = "Action Plan Admin: Validate 'Why this matters' via OpenAI"
    const val AP_ADMIN_VALIDATE_WORKING_WELL   = "Action Plan Admin: Validate 'What's Working Well' content via OpenAI"
    const val AP_ADMIN_VALIDATE_NEEDS_SUPPORT  = "Action Plan Admin: Validate 'What Needs Support' content via OpenAI"
    const val AP_ADMIN_VALIDATE_NUTRITION      = "Action Plan Admin: Validate Nutrition Guidance content via OpenAI"
    const val AP_ADMIN_BIOMARKER_SELECTOR      = "Action Plan Admin: Open biomarker selector dialog"
    const val AP_ADMIN_VITAMIN_SELECTOR        = "Action Plan Admin: Open vitamin/nutrient selector dialog"
    const val AP_ADMIN_ADD_SELECTED            = "Action Plan Admin: Click Add Selected and wait for API"
    const val AP_ADMIN_CREATE_SUBSECTION       = "Action Plan Admin: Click Create Subsection"
}