...
class TestDetailPage(page: Page) : BasePage(page) {
    ...
    fun verifyHowItWorksSection(sampleType: String, code: String, reportGenerationHr: String? = null, firstHighlight: String? = null): TestDetailPage {
        ...
        // Step: Results
        val resultsTitle = if (code == "CORTISOL1004") "Get results in 3–5 days" else if (code == "OMEGA1003") "Get results in 7–10 days" else if (type == "blood") "Get results in 72 hours" else (if (type == "saliva") "Get results in 3–4 weeks" else if (type == "stool") "Get results in 7–10 days" else "Get results in 72 hours")
